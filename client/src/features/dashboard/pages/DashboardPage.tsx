...
export default function DashboardPage() {
  const stats = useMemo(
    () => [
      { title: 'Pending Approvals', value: 142, icon: Clock, change: '+12%', changeType: 'warning' as const },
      { title: 'Approved Today', value: 38, icon: CheckCircle2, change: '+8%', changeType: 'success' as const },
      { title: 'Rejected Today', value: 7, icon: XCircle, change: '-2%', changeType: 'success' as const },
      { title: 'Request Changes', value: 5, icon: AlertTriangle, change: '+3%', changeType: 'warning' as const },
      { title: 'Approval Rate', value: 84.2, icon: TrendingUp, change: '+2.1%', changeType: 'success' as const, suffix: '%' },
      { title: 'Avg Review Time', value: 4.2, icon: Timer, change: '-0.3min', changeType: 'success' as const, suffix: 'min' },
      { title: 'Active Moderators', value: 8, icon: Users, change: '0', changeType: 'neutral' as const },
    ],
    [],
  );
